				...
				<div class="preview fl">
					<div class="midpic">
						<a href="{{asset($goods_info->logo)}}" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="{{asset($goods_info->logo)}}" alt="图片" />
							              <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '{{asset('/'.$goods_info->sm_logo)}}',largeimage: '{{asset('/'.$goods_info->logo)}}'}">
										<img src="{{asset($goods_info->sm_logo)}}" alt="图片" /></a>
								</li>
								@foreach($goods_pics as $k=>$v)
								<li >
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '{{asset('/'.$v->sm_pic)}}',largeimage: '{{asset('/'.$v->pic)}}'}">
										<img src="{{showImage($v->sm_pic)}}" alt="图片" /></a>
								</li>
								@endforeach
